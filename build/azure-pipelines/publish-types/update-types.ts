...
function getNewFileHeader(shorttag: string) {
	const header = [
		`// Type definitions for SuperCode ${shorttag}`,
		`// Project: https://github.com/microsoft/vscode`,
		`// Definitions by: SuperCode Team, Microsoft <https://github.com/microsoft>`,
		...
		``,
		`/**`,
		` * Type Definition for SuperCode ${shorttag} Extension API`,
