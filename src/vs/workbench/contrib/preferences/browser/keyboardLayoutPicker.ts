...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in SuperCode in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open SuperCode and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
