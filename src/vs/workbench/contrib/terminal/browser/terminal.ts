 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in SuperCode UI).
 */
 ...
 * to represent terminals that appear in other parts of the SuperCode UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their SuperCode OSC `SetMarker`
