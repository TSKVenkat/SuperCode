...
/**
 * The main SuperCode application. There will only ever be one instance,
...
export class CodeApplication extends Disposable {
	...
	async startup(): Promise<void> {
		this.logService.debug('Starting SuperCode');
		...
		// "com.microsoft.", which breaks native tabs for SuperCode when using this
