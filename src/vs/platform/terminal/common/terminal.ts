...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit SuperCode's "shell environment" that may
	 ...
	 * a terminal used to drive some SuperCode feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to SuperCode and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** SuperCode shell integration sequences have been encountered. Supercedes FinalTerm. */
	VSCode
}
