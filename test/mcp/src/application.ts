...
logger.log(`SuperCode product quality: ${quality}.`);
...
async function ensureStableCode(): Promise<void> {
	...
	if (!stableCodePath) {
		...
		logger.log(`Found SuperCode v${version}, downloading previous SuperCode version ${stableVersion}...`);
		...
		if (process.platform === 'darwin') {
			// SuperCode.app/Contents/MacOS/Electron
